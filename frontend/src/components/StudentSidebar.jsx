...
const bottomItems = [{ icon: Settings, label: "Settings", path: "/student/settings" }];

export function StudentSidebar({ isOpen, setIsOpen, isMobile }) {
          ...
          <div className="flex items-center justify-center flex-1">
            {isOpen ? (
              <div className="font-bold text-2xl text-black flex items-center gap-3">
                ...
                <span className="font-extrabold tracking-tight">Student</span>
              </div>
            ) : (
